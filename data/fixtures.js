...
exports.fixturesChassis = function fixturesChassis() {
  var chassis = [];
  chassis.push({
    name: 'chassis001', serial: '-', rack: '161a55', base: 1, height: 2
  });
  chassis.push({
    name: 'chassis002', serial: '-', rack: '161a55', base: 3, height: 2
  });
  chassis.push({
    name: 'chassis003', serial: '-', rack: '161a55', base: 5, height: 2
  });
  chassis.push({
    name: 'chassis004', serial: '-', rack: '161a55', base: 7, height: 2
  });
  chassis.push({
    name: 'chassis005', serial: '-', rack: '161a55', base: 9, height: 2
  });
  chassis.push({
    name: 'chassis006', serial: '-', rack: '161a55', base: 11, height: 2
  });
  chassis.push({
    name: 'chassis007', serial: '-', rack: '161a55', base: 13, height: 2
  });
  chassis.push({
    name: 'chassis008', serial: '-', rack: '161a55', base: 15, height: 2
  });
  chassis.push({
    name: 'chassis009', serial: '-', rack: '161a55', base: 17, height: 2
  });
  chassis.push({
    name: 'chassis010', serial: '-', rack: '161a55', base: 19, height: 2
  });
  chassis.push({
    name: 'chassis011', serial: '-', rack: '161a55', base: 21, height: 2
  });
  chassis.push({
    name: 'chassis012', serial: '-', rack: '161a55', base: 23, height: 2
  });
  chassis.push({
    name: 'chassis013', serial: '-', rack: '161a55', base: 25, height: 2
  });
  chassis.push({
    name: 'chassis014', serial: '-', rack: '161a55', base: 27, height: 2
  });
  chassis.push({
    name: 'chassisNode57', serial: '-', rack: '161a55', base: 27, height: 2
  });
  chassis.push({
    name: 'chassisServer1', serial: '-', rack: '161a55', base: 27, height: 2
  });
  chassis.push({
    name: 'chassisServer2', serial: '-', rack: '161a55', base: 27, height: 2
  });
  chassis.push({
    name: 'chassisLogin1', serial: '-', rack: '161a55', base: 27, height: 1
  });
  return chassis;
};
